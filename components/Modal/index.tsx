...
function Modal({ modalOpen = false, setModalOpen }: Props) {
  return modalOpen === true ? (
    <div>
      <div
        // onClick={() => setModalOpen(false)}
        className="fixed h-[100vh] bg-[#000000b2] inset-0 "
      >
        <div className=" w-full h-full flex justify-center items-center">
          <div className="bg-[#ffffff] w-[95%] md:w-[70%] lg:w-[650px] px-4 md:px-8 lg:px-14 py-8 lg:py-12 rounded-[15px] relative">
            <button
              onClick={() => setModalOpen(false)}
            ...
            <div>
              ...
              {/* <form action="">
                <input
                  type="text"
                  className="border-[3px] border-[#ff7562] rounded-[8px] w-full px-4 py-4 lg:py-5 mt-6 lg:mt-8"
                  placeholder="E-mail"
                />
                <div>
                  <a
                    ...
                    href=""
                  >
                    <button>Quero assistir a aula</button>
                  </a>
                </div>
              ...
              >
                <div style={{ display: "none" }}>
                  ...
                  <input
                    type="hidden"
                    name="inf_custom_GaContent"
                    value="null"
                  />
                  <input
                    type="hidden"
                    name="inf_custom_GaMedium"
                    value="null"
                  />
                  <input
                    type="hidden"
                ...
                <div className="text-center">
                  ...
                  <p className="montserrat font-weight-light">
